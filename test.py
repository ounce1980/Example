...
class Ui_MainWindow(object):
    ...
    def loaddata(self):
        ...
        btv_html = '<html><body><ul><li id="product_list_item_1"><a href="/products/product1.html" class="product-image"></a></li><li id="product_list_item_2"><a href="/products/product2.html" class="product-image"></a></li><li id="product_list_item_3"><a href="/products/product3.html" class="product-image"></a></li><li id="product_list_item_4"><a href="/products/product4.html" class="product-image"></a></li></ul></body></html>'
        ...
        for index, product_data in enumerate(soup.findAll('li', id=re.compile('^product_list_item_'))):
            ...
            #self.load_detail(product_url)

            name_title = "product " + str(index)
            price = "100.00"
            instock = "สินค้าพร้อมส่ง"

            #count_p = count_p+1

            self.addTableItem(name_title, price, instock)
    ...
    def addTableItem(self,name_title, price, instock):
        
        count_p = self.tableWidget.rowCount()
        print(count_p, name_title, price, instock)
        
        self.tableWidget.insertRow(count_p)
        self.tableWidget.setItem(count_p-1, 0, QtWidgets.QTableWidgetItem(name_title))
        self.tableWidget.setItem(count_p-1, 1, QtWidgets.QTableWidgetItem(price))
        self.tableWidget.setItem(count_p-1, 3, QtWidgets.QTableWidgetItem(instock))
        self.tableWidget.update()

    def load_detail(self,product_url):
        ...
        return name_title, price, instock
